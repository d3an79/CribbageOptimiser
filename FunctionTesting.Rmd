...
example of binding data.tables
x<-rbindlist(list(dt,dd),use.names = F,fill = F)
...
calculateOneHand<- function(chosenHand, discardedCards="")
{
  ...
  handPoints<- data.table(hand= paste(paste(c(h[1,1],h[1,2]),collapse=""),paste(c(h[2,1],h[2,2]),collapse="")
                                      ,paste(c(h[3,1],h[3,2]),collapse="")
                                      ,paste(c(h[4,1],h[4,2]),collapse=""),sep=","), # a better way of doing this?
